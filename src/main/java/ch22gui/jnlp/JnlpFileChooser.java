...
/**
 * Opening files on a local machine with JNLP. <br>
 * {Requires: javax.jnlp.FileOpenService; You must have javaws.jar in your
 * classpath} To create the jnlpfilechooser.jar file, do this: <br>
 * cd .. <br>
 * cd .. <br>
