...
/**
 * {Args: 1 10 10} (Fast verification check during build) Rough comparison of
 * thread-safe Map performance.
 * 
 * <pre>
 * Output: (Sample)
 ...
 * </pre>
 */
abstract class MapTest extends D71_Tester<Map<Integer, Integer>> {
...
public class D73_MapComparisons {
	public static void main(String[] args) {
		D71_Tester.initMain(args);
