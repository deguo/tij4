 ...
 * </pre>
 */
public class D19_SlowMap<K, V> extends AbstractMap<K, V> {
	...
	public Set<Entry<K, V>> entrySet() {
		...
		while (ki.hasNext())
			set.add(new D19_MapEntry<K, V>(ki.next(), vi.next()));
		return set;
	}

	public static void main(String[] args) {
		D19_SlowMap<String, String> m = new D19_SlowMap<String, String>();
