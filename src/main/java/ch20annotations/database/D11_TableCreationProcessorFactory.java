...
/**
 * The database example using Visitor.<br>
 * {Exec: apt -factory annotations.database.TableCreationProcessorFactory
 * database/Member.java -s database}
 */
public class D11_TableCreationProcessorFactory implements AnnotationProcessorFactory {
