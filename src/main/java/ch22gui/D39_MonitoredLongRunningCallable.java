...
public class D39_MonitoredLongRunningCallable extends JFrame {
    private JButton
    ...
    public D39_MonitoredLongRunningCallable() {
        b1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                MonitoredCallable task = new MonitoredCallable(
                        new ProgressMonitor(
                                D39_MonitoredLongRunningCallable.this,
    ...
    public static void main(String[] args) {
        run(new D39_MonitoredLongRunningCallable(), 200, 500);
    }
}